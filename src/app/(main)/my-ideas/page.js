                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead className="bg-gray-50 dark:bg-gray-900/50">
                            <tr>
                                <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Idea</th>
                                <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Category</th>
                                <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Date Posted</th>
                                <th className="px-6 py-4 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">Actions</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                            {myIdeas.map((idea) => (
                                <tr key={idea.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center">
                                            <div className="h-10 w-10 flex-shrink-0 bg-gray-200 rounded overflow-hidden border border-gray-200/50">
                                                <img 
                                                    src={idea.imageUrl} 
                                                    alt="" 
            ...
            {deleteModalOpen && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-fade-in">
                    <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl p-6 sm:p-8 shadow-2xl border border-gray-100 dark:border-gray-700 text-center space-y-4 animate-scale-in">
                        ...
                        <h3 className="text-xl font-black text-gray-900 dark:text-white tracking-tight">Confirm Deletion</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed font-semibold">
                            Are you sure you want to delete the idea "<span className="font-extrabold text-rose-500">{selectedIdea?.title}</span>"? This action is irreversible and cannot be undone.
                        </p>
            ...
            {editModalOpen && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-fade-in">
                    <div className="w-full max-w-lg bg-white dark:bg-gray-800 rounded-3xl p-6 sm:p-8 shadow-2xl border border-gray-100 dark:border-gray-700 relative animate-scale-in">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Update Idea</h3>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 font-medium">Edit the basic details of your shared concept.</p>
                        ...
                        <form onSubmit={handleEditSubmit} className="space-y-4 mt-6">
                            ...
                            <div className="form-control text-left">
                                ...
                                >
                                    {["Tech", "Health", "AI", "Education", "Finance", "E-commerce", "Other"].map(c => (
